...
module.exports = function(req, res)
{
	...
	console.log('== ver req session adminpublicaciones.js ==');
    console.log(req.session);
    console.log('== ver req user adminpublicaciones.js ==');
    ...
    if (!_.isUndefined(req.session.passport))
        ...
        Publicacion.find({}).sort({'publicado': -1}).exec(function(err, publicaciones){// acciones que procesar

        //----------------------
        console.log(publicaciones);
        locals.data.publicaciones = publicaciones;
        res.render('adminPublicacion', { message: req.flash('loginMessage') });
    });
